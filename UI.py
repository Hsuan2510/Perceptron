...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.learing_rate_spinBox = QtWidgets.QDoubleSpinBox(self.centralwidget)
        ...
        self.learing_rate_spinBox.setSingleStep(0.01)
        ...
        self.weight_label.setGeometry(QtCore.QRect(590, 590, 300, 50))
